...
import dev.isksss.java.sqlformatter.core.engine.core.util.RegexUtil;
...
public class Tokenizer {
  ...
  private final Pattern DATA_TYPE_PATTERN;
  ...
  public Tokenizer(DialectConfig cfg) {
    ...
    this.DATA_TYPE_PATTERN =
        Pattern.compile(RegexUtil.createReservedWordRegex(new JSLikeList<>(cfg.dataTypes)));
  ...
  private Token getDataTypeToken(String input) {
    return this.getTokenOnFirstMatch(input, TokenTypes.DATA_TYPE, this.DATA_TYPE_PATTERN);
  }
